# Description
Copy the input to the ouput, in order, so that the final value at 41 is the initial value at -121, the final value at 42 is the initial one at -120, and so on up until the final value at 121 being the initial value at -41.
